...
import { clearArray } from "https://cdn.jsdelivr.net/gh/pwall2222/OmClient@1.0.1/javascript/modules/array.js";
...
class PeerConnection extends RTCPeerConnection {
	constructor() {
		...
		this.onicecandidate = async (event) => {
			...
			await backend.sendIdentifiedPOST("icecandidate", {
	...
	async offer(options) {
		...
		backend.sendIdentifiedPOST("rtcpeerdescription", {
			desc: videoSession,
		});
	}
